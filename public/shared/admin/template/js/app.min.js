...
function deletePost(id) {
    $.get(site_adr + "post.php?admin=delete_post",
        {
            'id': id
        }, function (data) {
...
$(document).ready(function () {
    ...
    $("button[name=save_routing]").on('click', function () {
            $.each($('input[name^="route\\["]').serializeArray(), function () {
